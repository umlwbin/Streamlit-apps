QUALIFIER_COLUMNS = {
    ...
    "wind_speed": "wind_speed_result_value_qualifier",
    "wind_speed_of_gust": "wind_speed_of_gust_result_value_qualifier",
    "wind_from_direction": "wind_from_direction_result_value_qualifier",
}
