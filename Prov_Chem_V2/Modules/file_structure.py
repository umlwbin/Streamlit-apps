...
def choose_file_structure_widgets():
    ...
    structure_radio_button=st.radio("Select a format", options=['Your file has one row of **headers**, **VMV codes** and **units**, and you would like to restructure the file so that there is only one header row with the VMV codes and units added ot the column names.',
